<%-- 
    Document   : about
    Created on : Apr 3, 2015, 10:42:52 PM
    Author     : hyE
--%>
...
<html>
    ...
    <table id="noop1" width="1114" border="0" align="center">
      <tr>
        <td><form name="form1" method="post" action="editdetail.jsp">
          <input type="submit" name="button" id="button" value="       Update your details :)       ">
    ...
    <table  width="1006" height="408" border="0" align="center">
      <tr>
       ...
       //     String path="userdata\\"+email+"\\dpp\\pp.jpg";
    ...
    <table width="1223" border="0" align="left" style="font-family: 'Courier New','Verdana',sans-serif;
    			font-size:30px;
                text-align:left; 
                padding-left:5cm;"
                >
<tr>
      ...
      <tr>
        <td><label><b>Email : </b></label><%=email%></td>
