...
<html>
    ...
    <body >
        ...
        <table id="noop" width="1352" height="450" border="0">
          <tr>
            <td><div id="mydiv1">
              <table id="noop1" width="433" height="315" border="5" align="center">
                <tr>
                  <td><a href ="delac.jsp" style="text-decoration:none; color:black;font-size: 20px;">Delete account</a></td>
                </tr>
              </table>
            </div></td>
          </tr>
