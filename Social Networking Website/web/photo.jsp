        ...
        <table id="noopnew" width="1352" height="450" border="0">
          <tr>
            <td><div id="mydiv1">
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Waan'a upload photo?? then choose a pic :</label><br>
        <FORM  ENCTYPE="multipart/form-data" ACTION="fileupload.jsp" METHOD=POST>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" name="f1" onblur="disppic(this.value)">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Upload Pic">

        </FORM>
        
        <br><br><br><br>
      Uploaded photos: <br><br><br>
      <%
          ...
          for(File x:ar)
                {   
                    String rpath="userdata/"+str+"/"+x.getName();
                        %>
