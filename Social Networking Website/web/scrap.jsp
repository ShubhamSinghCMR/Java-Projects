...
<html>
    ...
    <body >
        ...
        <form name="form1" method="post" action="scrapserv">
        <label>Waan'a post scrap??</label>
          <textarea name="textarea" id="textarea" cols="90" rows="3"></textarea>
                ...
                while(rs.next())
                    {
                        ...
                        if(re.equals(val))  
                             {  String myscrap=rs.getString(3);
                             String sender=rs.getString(1);
                                out.println("Scrap no."+i+", Posted by : "+sender+" <br>"+myscrap+"<br><br><br>");
                                i++;
                              }
                    }   
