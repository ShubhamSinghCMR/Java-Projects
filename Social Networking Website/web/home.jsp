...
<html>
    ...
    <body onload="loadit('welcome.jsp'),hisfor()">
        <table id="noop" width="1328" height="62" border="0">
          <tr>
              <td height="58" ><br><b><a onclick="loadit('welcome.jsp')">hOme</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="loadit('about.jsp')">abOuT</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="loadit('stuff.jsp')">stufF</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="log()">lOgOuT</a>
                                             </b>
