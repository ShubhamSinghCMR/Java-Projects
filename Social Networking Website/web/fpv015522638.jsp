...
<html>
    ...
    <body >
        ...
        <%
            ...
            String email=(String)session.getAttribute("friend");
    ...
    <p></p>
    <table width="902" height="53" border="0" align="center" id="noop1">
      <tr>
        <td><a href="scrapvisit.jsp" style="text-decoration:none; color:black;font-size: 20px;"><b>Scrapbook</b></a></td>
        <td><a href="writetest.jsp" style="text-decoration:none; color:black;font-size: 20px;"><b>Testimonials</b></a></td>
        <td><a href="photovisit.jsp" style="text-decoration:none; color:black;font-size: 20px;"><b>Photos</b></a></td>
     
        <td><form name="form1" method="post" action="delfr">
          <input type="submit" name="button" id="button" value="    - Unfriend    ">
        </form></td>
      </tr>
    </table>
    <table width="200" border="0" align="center">
      <tr>
        <td><img src="pics/line.jpg" width="1014" height="1"></td>
      </tr>
    </table>
    <br>
    <table  width="972" height="459" border="0" align="center">
      <tr>
        <td width="442">
    ...
    <table width="1106" border="0" align="left" style="font-family: 'Courier New','Verdana',sans-serif;
    			font-size:30px;
                text-align:left; 
                padding-left:5cm;"
                >
<tr>
          <td width="995"><label><b>about me..</b></label><br><%=p5%></td>
